...
import com.dog.R;
import com.dog.video.GSYTextureView;
import com.dog.video.GSYVideoManager;
import com.dog.video.GSYVideoPlayer;
import com.dog.video.SmallVideoTouch;
import com.dog.video.listener.GSYMediaPlayerListener;
import com.dog.video.listener.VideoAllCallBack;
import com.dog.video.utils.CommonUtil;
import com.dog.video.utils.Debuger;
import com.dog.video.utils.OrientationUtils;
...
import static com.dog.video.utils.CommonUtil.getActionBarHeight;
import static com.dog.video.utils.CommonUtil.getBottomBarHeight;
import static com.dog.video.utils.CommonUtil.getStatusBarHeight;
import static com.dog.video.utils.CommonUtil.hideNavKey;
import static com.dog.video.utils.CommonUtil.hideSupportActionBar;
import static com.dog.video.utils.CommonUtil.showNavKey;
import static com.dog.video.utils.CommonUtil.showSupportActionBar;
...
public abstract class GSYBaseVideoPlayer extends FrameLayout implements GSYMediaPlayerListener {
    ...
    private boolean mShowFullAnimation = false;//是否使用全屏动画效果
    ...
    public GSYBaseVideoPlayer showSmallVideo(Point size, final boolean actionBar, final boolean statusBar) {
        ...
        try {
            ...
            //减去底部栏的高度
            marginTop = marginTop - getBottomBarHeight((Activity) mContext);
